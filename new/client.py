...
=======
        if overlap(bbox, groundTruth) > 0.2:
>>>>>>> 3a4cd67a9a3f16e55c65a1cb25f2644495d50ca0
...
>>>>>>> 3a4cd67a9a3f16e55c65a1cb25f2644495d50ca0
    ...
    def _CT_preForAdjust(self, detection=None): # CT
        ...
        if self.DETECTED:
            ...
            self.CT_box_update = (box_old+cfg.MULTI*(detection-box_old)).astype(np.int)
            self.CT_box_update = self.CT_box_update.tolist()
...
class Stack():
    ...
    def correlation_tracker(self):
        ...
        for track in self.tracks:
            if track.USE_CT:
                ...
                track.CT_run(self.img, self.img_old) # update tracks
    ...
    def createNewTracks(self, unassignedDetections, detection):
        ...
        for i in xrange(nNew):
            ...
            if self.idx < 20:
                track = Track(self.trackerID, bbox, self.groundTruth)
            else:
...
if __name__ == '__main__':
    # URL = 'http://yaolaoban.eva0.nics.cc:5000/fulldetect'
    URL = 'http://0.0.0.0:5000/fulldetect'
    this_file_path = os.path.dirname(os.path.abspath(__file__))
<<<<<<< HEAD
    imdb_name = 'jogging'#'jogging'
=======
    imdb_name = 'woman'#'jogging'#'jogging'
>>>>>>> 3a4cd67a9a3f16e55c65a1cb25f2644495d50ca0
